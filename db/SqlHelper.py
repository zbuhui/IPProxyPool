...
class SqlHelper(ISqlHelper):
    params = {'lasttime':Proxy.lasttime,'ip': Proxy.ip, 'port': Proxy.port, 'types': Proxy.types, 'protocol': Proxy.protocol,
    ...
    def insert(self, value):
        proxy = Proxy(lasttime=value['lasttime'],ip=value['ip'], port=value['port'], types=value['types'], protocol=value['protocol'],
